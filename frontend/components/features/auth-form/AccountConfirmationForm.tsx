        ...
        >
          <SubtitleDiv>
            ...
            <GridItem xs={12} paddingBottom="1.25rem">
              <SwitchTab>
               Please verify your email id by clicking on the verification link sent to "abc@gmail.com"
          ...
          <GridContainer spacing={2}> 
                    ...
                    <GridItem xs={12} paddingBottom="1.25rem">
                      <SwitchTab>
                        Didn't received verification link? <Link href="#" onClick = {resendConfirmation}>Resend link</Link>
                      </SwitchTab>
                    </GridItem>
                  </GridContainer>
        </ModalComponent>
