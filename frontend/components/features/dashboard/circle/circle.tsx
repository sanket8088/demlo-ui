...
export const CircleContainer =()  => {
  return (
    <Main>
    <ConnectionContainer title="Circles to join" children ={
      <>
      <CircleNextContainer>
        <NextIcon />
        </CircleNextContainer>
       ...
       <SquadContainer name={"Math Squad"} />
        ...
        <ConnectionContainer title="Top Squads to connect" children={
          <SquadList>
          <ConnectFriend name={"Liam"} grade={"6"} university={"Christian Middle"} />
          <ConnectFriend name={"Stuart"} grade={"6"} university={"Christian Middle"} />
          <ConnectFriend name={"Liam"} grade={"6"} university={"Christian Middle"} />
          <NextContainer>
            See More
          <NextIcon />
